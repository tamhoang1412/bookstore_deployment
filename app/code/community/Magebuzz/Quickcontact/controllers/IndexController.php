        ...
        if ( $post ) {
            ...
            try {
                ...
                $mailTemplate->setDesignConfig(array('area' => 'frontend'))
                    ...
                    ->sendTransactional(
                    Mage::getStoreConfig(self::XML_PATH_EMAIL_ADMIN_TEMPLATE),
                    Mage::getStoreConfig(self::XML_PATH_EMAIL_ADMIN_SENDER),
                    Mage::getStoreConfig(self::XML_PATH_RECEPTION_EMAIL_ADMIN),
                    null,
                ...
                $mailTemplate->setDesignConfig(array('area' => 'frontend'))
                    ...
                    Mage::getStoreConfig(self::XML_PATH_EMAIL_CUSTOMER_SENDER),
                    $customerEmail,
                    null,
                    array('data' => $postObject)
                );
