...
class Magebuzz_Quickcontact_Block_Adminhtml_Quickcontact_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('name', array(
          'header'    => Mage::helper('quickcontact')->__('Customer Name'),
          'align'     =>'left',
          'index'     => 'name',
      ));
	  $this->addColumn('email', array(
		...
		$this->addColumn('telephone', array(
				  'header'    => Mage::helper('quickcontact')->__('Telephone'),
				  'align'     =>'left',
				  'index'     => 'telephone',
			  ));	  
	  /*
	...
	$this->addColumn('status', array(
          'header'    => Mage::helper('quickcontact')->__('Status'),
          'align'     => 'left',
          'width'     => '80px',
          'index'     => 'status',
          'type'      => 'options',
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption'   => Mage::helper('quickcontact')->__('Edit'),
                        'url'       => array('base'=> '*/*/edit'),
                        'field'     => 'id'
                    )
                ),
