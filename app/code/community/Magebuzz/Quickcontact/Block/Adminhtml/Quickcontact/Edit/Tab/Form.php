...
class Magebuzz_Quickcontact_Block_Adminhtml_Quickcontact_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('name', 'text', array(
          'label'     => Mage::helper('quickcontact')->__('Customer Name'),
  ...
  $fieldset->addField('telephone', 'text', array(
          'label'     => Mage::helper('quickcontact')->__('Telephone'),
          'required'  => false,
          'name'      => 'telephone',
      ));
	$fieldset->addField('comment', 'textarea', array(
          'label'     => Mage::helper('quickcontact')->__('Comment'),
          'required'  => true,
	 ...
	 $fieldset->addField('status', 'select', array(
          ...
          'values'    => array(
              array(
                  'value'     => 1,
                  'label'     => Mage::helper('quickcontact')->__('Enabled'),
              ),

              array(
                  'value'     => 2,
                  'label'     => Mage::helper('quickcontact')->__('Disabled'),
              ),
          ),
      ));
